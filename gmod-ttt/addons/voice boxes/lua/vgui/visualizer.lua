...
function PANEL:Paint()
	...
	if !self:GetPly() or !IsValid(self:GetPly()) or !self:GetPly():IsPlayer() then return end
	...
	local voice_volume = VOICEVIS.VisualizerSetting[self:GetVis()].MULTIPLIER * ply:VoiceVolume()
