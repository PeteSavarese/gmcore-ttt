...
---@param weapon Entity The weapon entity that fired
...
---@param ply Player Recipient player to send the damage info to
---@param t table Time-indexed damage data
---@param att number Attacker damagelog ID
---@param victim number Victim damagelog ID
---@param round number Round number to retrieve shoot logs from
