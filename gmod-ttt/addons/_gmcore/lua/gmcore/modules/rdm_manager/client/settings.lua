...
hook.Add("TTTSettingsTabs", "DamagelogsTTTSettingsTab", function(dtabs)
	...
	dgui:SetLabel(TTTLogTranslate(GetDMGLogLang, "Generalsettings"))
	local selectedcolor
	...
	colorSettings:SetLabel(TTTLogTranslate(GetDMGLogLang, "Colors"))
