DamagelogLang.english = {
		...
		RDMInvalid = "Invalid",
		RDMInvalidWvW = "Invalid (WvW)",
		RDMValid = "Valid",
		RDMCanceled = "Forgiven by the victim",
		RDMSetConclusion = "Set conclusion",
		Conclusion = "Conclusion",
		RDMWriteConclusion = "Write the conclusion for this report",
		...
		NoDeathSceneId = "This Death Scene does not have an ID and cannot be loaded.",
		Victim = "Victim",
		...
		ShowFinishedReports = "Show resolved reports",
		SStatus = "Set Status",
		VictimsReport = "Report",
		AdminsMessage = "Staff message",
		ReportedPlayerResponse = "Response",
		...
		BeenReported = "You have been reported! Answer all your reports.",
		...
		HasCanceledReport = "%s has forgiven the report #%s.",
		TheReport = "The report",
		HasCanceledByVictim = "has been forgiven by the victim!",
		...
		DeathstationPlaced = "%s [%s] placed a deathstation",
		TripminePlaced = "%s [%s] placed a tripmine",
		...
		RoundBought = "%s bought pointshop role: %s",
		...
		TrapWarning = "%s warned for a trap: %s",
		OtherWarning = "%s warned for the use of their %s",
		CorpseOf = "corpse of ",
		traitor = "traitor",
		detective = "detective",
		...
		FullDeathScene = "Full Death Scene",
		FullDeathSceneTooltip = "View the entire round leading up to the most recent death",
		SelectRoundFirst = "Select a round first",
		NoFullRoundSceneAvailable = "No full round death scene available for this round",
		...
		PleaseSelectRound = "Select a round!",
		...
		CancelReport = "Forgive this report",
		ReportCanceled = "Report forgiven",
		AlreadyCanceled = "You have forgiven this report",
		...
		filter_show_psroles = "Show PS role purchases",
		...
		filter_show_traitor_warnings = "Show traitor warnings",
		-- Colors
		...
		color_traitor_warnings = "Traitor warnings",
		-- Discord webhook
