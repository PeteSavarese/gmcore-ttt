---Ragdoll creation, body identification, searching, and
---detective selection for slain players.
...
---@param rag Entity The player ragdoll entity
---@param state boolean Whether the body has been found
...
---@param rag Entity The player ragdoll entity
---@param ply_or_name Player|string A player entity or a nickname string
...
---@param rag Entity The player ragdoll entity
---@param credits number Number of credits on the corpse
...
---@param ply Player The player performing the search
---@param rag Entity The player ragdoll being searched
---@param covert boolean Whether this is a covert (traitor) search
---@param long_range boolean Whether the search is from a distance
...
---@param ply Player The player who died
---@param attacker Entity The entity that killed the player
---@param dmginfo CTakeDamageInfo Damage info from the killing blow
---@return Entity? rag The created ragdoll, or nil on failure
function CORPSE.Create(ply, attacker, dmginfo)
	if not IsValid(ply) then return end
	if hook.Run("TTTPreCreateCorpse", ply) == false then return nil end
	...
	ply:SetNWEntity("ttt_ragdoll", rag)
