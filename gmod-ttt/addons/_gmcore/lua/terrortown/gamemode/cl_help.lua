---Adds unidentified-body halo toggle.
...
CreateClientConVar("ttt_unid_halo", "1", true)

---@class HELPSCRN
HELPSCRN = {}

local dframe
---Opens the help/settings window. Does nothing if already open.
function HELPSCRN:Show()
	...
	cb = dplay:CheckBox("Highlight unidentified bodies", "ttt_unid_halo")
	cb:SetTooltip("Enable to highlight unidentified bodies that are nearby and visable.")
...
---@param parent Panel Parent VGUI panel the tutorial image/nav is created in
