...
---@param name string Display name for the group header
---@param color Color Header background colour
---@param group number GROUP_* constant
...
---@param ply Player Player to add a row for (if they belong to this group)
...
---@param ply Player Player to check for an existing row
---@return boolean exists Whether a row exists for this player
function PANEL:HasPlayerRow(ply)
	return self.rows[ply] != nil
end

---@return boolean hasRows Whether the group has any player rows
