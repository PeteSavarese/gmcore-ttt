...
---Base stuff
---@class TTTScorePlayerInfoBase : Panel
local PANEL = {}
...
---@param ply Player The player whose info to display
function PANEL:SetPlayer(ply)
	self.Player = ply
	self:UpdatePlayerData()
end

---Override in subclasses to refresh displayed data.
...
---@class TTTScorePlayerInfoSearch : TTTScorePlayerInfoBase
local PANEL = {}
...
---@class TTTScorePlayerInfoTags : TTTScorePlayerInfoBase
local PANEL = {}

function PANEL:Init()
	self.TagButtons = {}

	for k, tag in ipairs(scoreboard_tags) do
