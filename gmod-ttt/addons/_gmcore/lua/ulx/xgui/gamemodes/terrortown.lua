---Client-side XGUI settings panel for Trouble in Terrorist Town.
---Builds the "TTT" tab inside the ULX GUI with collapsible categories for
---round structure, gameplay, traitor/detective counts, DNA, voice-chat battery,
---karma, credits, prop possession, admin settings, and miscellaneous TTT cvars.
---Settings changed here are session-only and do not persist across map changes.
