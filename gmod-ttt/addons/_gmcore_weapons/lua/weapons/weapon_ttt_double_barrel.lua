...
if CLIENT then
	...
	SWEP.Icon               = "vgui/ttt/icon_gl_dbarrel"
	SWEP.IconLetter         = "B"
end
...
SWEP.UseHands              = true
SWEP.ViewModel             = "models/weapons/double_barrel/v_doublebarrl.mdl"
SWEP.WorldModel            = "models/weapons/double_barrel/w_double_barrel_shotgun.mdl"
