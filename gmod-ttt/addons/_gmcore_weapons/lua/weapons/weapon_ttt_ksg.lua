...
if CLIENT then
	...
	SWEP.Icon               = "vgui/ttt/icon_gl_ksg"
	SWEP.IconLetter         = "B"
end
...
SWEP.Primary.Sound         = Sound( "Weapon_KSG.Single" )
...
SWEP.UseHands              = true
SWEP.ViewModel             = "models/weapons/ksg/v_ksg_raven.mdl"
SWEP.WorldModel            = "models/weapons/ksg/w_ksg_raven.mdl"

SWEP.IronSightsPos = Vector(-1.405, -1.5, 0.18)
