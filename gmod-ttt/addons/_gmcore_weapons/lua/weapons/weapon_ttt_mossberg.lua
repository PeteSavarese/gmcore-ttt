...
if CLIENT then
	...
	SWEP.Icon               = "vgui/ttt/icon_gl_mossberg"
	SWEP.IconLetter         = "B"
end
...
SWEP.UseHands              = true
SWEP.ViewModel             = "models/weapons/mossberg/v_shot_mberg_590.mdl"
SWEP.WorldModel            = "models/weapons/mossberg/w_mossberg_590.mdl"
